    ...
    moreServicesMenu: {
      ...
      rows:
        ...
        [
          ...
          { id: "DOWNLOAD_TREND_REPORTS", title: "📈 Download Trend Reports" },
...
export async function sendReportInputPrompt({
  ...
  const payload = {
    ...
    interactive: {
      type: "button",
      body: {
        text: "Share Requisition No / MR No / registered phone, or attach requisition slip image."
      },
      action: {
        buttons: [
          {
            type: "reply",
            reply: {
              id: "REPORT_USE_REGISTERED_NUMBER",
              title: "Use my registered number"
            }
          },
          {
            type: "reply",
...
export async function sendReportPostDownloadMenu({
  ...
  const payload = {
    ...
    interactive: {
      type: "button",
      body: {
        text: "Would you like to download a trend report, choose another report, or go back to the main menu?"
      },
      action: {
        buttons: [
          {
