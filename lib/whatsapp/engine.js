...
import { getTrendReportUrl, lookupReports } from "@/lib/neosoft/client";
...
export async function processMessage(session, userInput, phone, options = {}) {
  ...
  switch (state) {
      ...
      if (input.startsWith("REPORT_")) {
        ...
        return {
          ...
          context: {
            ...
            selected_report_reqno: entry?.reqno || null,
    ...
    case "REPORT_POST_DOWNLOAD_MENU": {
      ...
      if (input === "REPORT_DOWNLOAD_ANOTHER") {
