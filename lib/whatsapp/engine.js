...
export async function processMessage(session, userInput, phone, options = {}) {
  ...
  switch (state) {
    ...
    case "BOOKING_SLOT":
      ...
      return {
        replyType: "BOOKING_LOCATION_MENU",
        newState: "BOOKING_LOCATION_CHOICE",
        context
      };
    ...
    case "BOOKING_LOCATION_CHOICE":
      if (input === "SHARE_CURRENT_LOCATION") {
        return {
          ...
          replyText: getFlowText(
            botFlowConfig,
            "booking_location_pin_prompt",
            "Please send your current location pin from WhatsApp attachment menu."
          ),
          newState: "BOOKING_LOCATION_WAITING_PIN",
          context
        };
      }
      ...
      if (input === "SHARE_CUSTOM_LOCATION") {
        return {
          ...
          replyText: getFlowText(
            ...
            "Please type landmark/address or paste Google Maps link."
          ),
      ...
      if (input === "SKIP_LOCATION") {
        ...
        return {
          ...
          replyText: getFlowText(
            botFlowConfig,
            "booking_prescription_prompt",
            "If you have a prescription, please send image/pdf now. Otherwise type SKIP."
          ),
          newState: "BOOKING_PRESCRIPTION_WAITING",
          context
        };
      }
    ...
    case "BOOKING_LOCATION_WAITING_PIN":
      ...
      return {
        ...
        replyText: getFlowText(
          botFlowConfig,
          "booking_location_pin_invalid",
          "Please send a location pin, or type SKIP_LOCATION to continue without location."
        ),
        newState: "BOOKING_LOCATION_WAITING_PIN",
        context
      };
    ...
    case "BOOKING_PRESCRIPTION_WAITING":
      if (options?.inboundMedia?.url) {
        ...
        return {
          ...
          replyText: getFlowText(
            botFlowConfig,
            "booking_test_prompt",
            "Please enter the tests or package name."
          ),
          newState: "BOOKING_TEST_DETAILS",
          context
        };
      }

      if (["SKIP", "SKIP_PRESCRIPTION", "NO", "N"].includes(input)) {
        return {
          replyType: "TEXT",
          replyText: getFlowText(
            botFlowConfig,
      ...
      return {
        ...
        replyText: getFlowText(
          botFlowConfig,
          "booking_prescription_retry",
          "Please send prescription image/pdf, or type SKIP."
        ),
        newState: "BOOKING_PRESCRIPTION_WAITING",
        context
      };
