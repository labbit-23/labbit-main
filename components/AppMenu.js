...
const FALLBACK_ROLE_PERMISSIONS = {
  ...
  consultant: ["archive.patient.view"],
...
const MENU_GROUPS = [
  {
    ...
    items: [
      ...
      { key: "patient_archive", label: "Patient Archive", description: "Historical Shivam patient history", href: "/patient-archive", icon: Archive, roles: ["admin", "manager", "director", "director_ceo", "consultant"], permissions: ["archive.patient.view"] },
